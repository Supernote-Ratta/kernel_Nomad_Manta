...
static int rk817_bat_get_temp(struct rk817_battery_device *battery)
{
	...
	//	adc_to_vol -= 7; //
	//}
	//if(battery->current_avg >0){//103³äµçÊ±adc»á±È²»²å³äµçÆ÷Ð¡,78²å³äµçÆ÷adc»áÉý¸ß
	...
	if(adc_to_vol > battery->pdata->temp_t[1]-10){ // 15-17// adc 55»á×Ô¶¯²»³äµç
		return 17;
	}
...
// å°äºŽ0 å¤§äºŽ50 ä¸å……ç”µ
// 0-10 45-60 ä½Žç”µæµå……ç”µ ä½Žç”µåŽ‹å……ç”µ
// 10-45 æ­£å¸¸å……ç”µ
	struct rk817_charger* charge = rk817_charge_get_charger();
	int status;
