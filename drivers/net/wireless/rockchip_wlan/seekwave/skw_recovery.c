...
static void skw_recovery_work(struct work_struct *wk)
{
	...
	struct skw_recovery_data *rd = SKW_GET_RECOVERY_DATA();
...
{
	mutex_init(&g_skw_recovery.lock);
