...
uint8_t const FW8064_WorkMode_Cmd[12][3] = {
    WorkMode_Idle_Cmd, WorkMode_Sleep_Cmd, WorkMode_Fdt_Cmd,
    WorkMode_Img_Cmd, WorkMode_Nav_Cmd, WorkMode_SysRst_Cmd, 
    WorkMode_AfeRst_Cmd, WorkMode_FdtRst_Cmd, WorkMode_FifoRst_Cmd,
    WorkMode_OscOn_Cmd, WorkMode_OscOff_Cmd, WorkMode_SpiWakeUp
};
