...
int light_stk3x1x_get_value(void)
{
    int result = 0;
    ...
    sensor_active(client_test, 1, 9600);
    result = sensor_report_value(client_test);
    printk("[light_stk3x1x_get_value] %s: result=%4d\n", __func__, result);

    return result;
}
EXPORT_SYMBOL(light_stk3x1x_get_value);

void light_stk3x1x_set_cal_factor(int level)
{
    int result = 0;
...
EXPORT_SYMBOL(light_stk3x1x_set_cal_factor);

int light_stk3x1x_get_cal_factor(void)
{
    int result = 0;
...
EXPORT_SYMBOL(light_stk3x1x_get_cal_factor);

void set_stk3x1x_cali_value(int value)
{
...
EXPORT_SYMBOL(set_stk3x1x_cali_value);

int get_stk3x1x_cali_value(void)
{
    int result = 0;
...
EXPORT_SYMBOL(get_stk3x1x_cali_value);
