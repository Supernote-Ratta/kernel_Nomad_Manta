...
#define FTS_DEBUG(fmt, args...) do { \
    printk("[FTS_SLIDE_TS]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_FUNC_ENTER() do { \
    printk("[FTS_SLIDE_TS]%s: Enter\n", __func__); \
} while (0)

#define FTS_FUNC_EXIT() do { \
    printk("[FTS_SLIDE_TS]%s: Exit(%d)\n", __func__, __LINE__); \
} while (0)
...
#define FTS_INFO(fmt, args...) do { \
    printk(KERN_INFO "[FTS_SLIDE_TS/I]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_ERROR(fmt, args...) do { \
    printk(KERN_ERR "[FTS_SLIDE_TS/E]%s:"fmt"\n", __func__, ##args); \
} while (0)
